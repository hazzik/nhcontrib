...
namespace NHibernate.Linq.Visitors
{
    ...
    public class BinaryCriterionVisitor : NHibernateExpressionVisitor
    {
			...
			BinaryExpression expr)
		{
			...
			var left = new SelectArgumentsVisitor(rootCriteria, session);
			var right = new SelectArgumentsVisitor(rootCriteria, session);
			...
			else
			{
				...
				projections[1] = right.Projection;
			}
			return projections;
		}
    }
